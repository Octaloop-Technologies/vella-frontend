...
const HeroSection: React.FC = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center overflow-hidden bg-[#F7F7F7] pt-20 lg:pt-20"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div className="space-y-5 sm:space-y-6 md:space-y-7">
          ...
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/50 shadow-sm">
            ...
            <span className="text-xs sm:text-sm md:text-base text-black font-medium">
              Now in Beta — Join the Voice AI Revolution
            </span>
          </div>
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-black leading-relaxed max-w-xl">
            Your AI-Powered Voice + Chat Automation Engine{" "}
            <br className="hidden sm:block" /> Light, Fast and Designed to
            Scale.
          </p>
          ...
          <div className="flex flex-wrap justify-center sm:justify-start gap-3 sm:gap-4 pt-6 sm:pt-8">
            <div className="flex flex-col items-center bg-white/80 backdrop-blur-sm px-4 py-3 sm:py-4 rounded-xl border border-gray-100 shadow-card min-w-[150px]">
              <div className="text-base sm:text-lg font-bold text-[#099BBD]">
                99.9%
              </div>
            ...
            <div className="flex flex-col items-center bg-white/80 backdrop-blur-sm px-4 py-3 sm:py-4 rounded-xl border border-gray-100 shadow-card min-w-[150px]">
              ...
              <div className="text-xs sm:text-sm text-black mt-0.5">
                Response Time
              </div>
            </div>
            <div className="flex flex-col items-center bg-white/80 backdrop-blur-sm px-4 py-3 sm:py-4 rounded-xl border border-gray-100 shadow-card min-w-[150px]">
        ...
        <div className="relative w-full  h-[300px] sm:h-[400px] md:h-[500px] lg:h-full mt-8 lg:mt-0 flex justify-center items-end">
          ...
          <div className="flex flex-row xl:flex-col items-center justify-center w-full h-full relative">
            {/* Waveform Background */}
            <Waveform className="right-[-38%] absolute -bottom-24  left-10 sm:-bottom-28 md:-bottom-20 md:left-20 w-full scale-75 sm:scale-90 md:scale-100" />
