            ...
            <div className="relative max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-7">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/50 shadow-sm">
                        ...
                        <span className="text-sm text-gray-700">Now in Beta — Join the Voice AI Revolution</span>
                    </div>

                    {/* Main Heading */}
                    <h1 className="text-6xl md:text-7xl font-bold text-[#099BBD] leading-tight">
                        Meet VELA
                    </h1>
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        <Link href="/signup">
                            <button className="px-8 py-4 bg-gradient-to-b from-[#8266D4] to-[#41288A] text-white rounded-lg font-semibold text-base shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center gap-2">
                                Start Building Free
                        ...
                        <button className="px-8 py-4 bg-white backdrop-blur-sm text-[#41288A] rounded-lg font-semibold text-base hover:bg-white flex items-center gap-2">
                            Watch Demo
                    ...
                    <div className="flex flex-wrap gap-4 pt-8">
                        <div className="flex flex-col items-center bg-white/80 backdrop-blur-sm px-6 py-4 rounded-xl shadow-md border border-gray-100">
                ...
                <div className="relative flex items-center justify-center w-full h-full">
                    ...
                    <Image
                        ...
                        width={300}
                        height={300}
                        className="absolute object-contain -top-28 right-12 bird-float"
                    />
