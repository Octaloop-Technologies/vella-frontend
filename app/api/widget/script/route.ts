  ...
  window.VellaWidget = {
    init: function(userConfig) {
      ...
      config = {
        ...
        showAvatar: userConfig.showAvatar !== undefined ? userConfig.showAvatar : true,
        showTitle: userConfig.showTitle !== undefined ? userConfig.showTitle : true,
        showDuration: userConfig.showDuration !== undefined ? userConfig.showDuration : true,
        buttonColor: userConfig.buttonColor || '#8266D4',
        iconColor: userConfig.iconColor || '#FFFFFF',
        apiBaseUrl: '${
      ...
      const html = \`
        ...
        <div class="vella-voice-card">
          ...
          <div class="vella-content-area">
            <!-- Timer (Conditionally visible based on showDuration) -->
            \${config.showDuration ? \`
            ...
            \` : '<div class="vella-rec-status" style="height: 30px;"></div>'}
            ...
            <div style="position: relative; width: 80px; height: 80px; margin: 0 auto;">
              ...
              <div class="vella-status-indicator" id="vella-status-indicator" style="display: none; color: \${config.iconColor};">
