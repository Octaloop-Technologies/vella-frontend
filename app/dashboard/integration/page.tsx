  ...
  const integrationsData: Integration[] = [
    {
      ...
      icon: (
        <div className="w-16 h-16 bg-[#1877F21A] p-1 rounded-xl flex items-center justify-center">
          {/* Placeholder for GHL Icon, using text or a generic icon if image not available */}
          <Image src="/dashboard/png/ghl-logo2.png" alt="GoHighLevel" width={42} height={42} />
        </div>
      ),
      badges: ghlStatus?.is_connected
        ? [
            { label: "Connected", variant: "connected" },
            { label: "CRM", variant: "popular" },
          ]
        : [
            { label: "Not Connected", variant: "notConnected" },
            { label: "CRM", variant: "popular" },
          ],
      connectedDate: ghlStatus?.connected_at
        ? new Date(ghlStatus.connected_at).toLocaleDateString()
        : undefined,
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-black mt-2 font-medium text-sm opacity-70">
